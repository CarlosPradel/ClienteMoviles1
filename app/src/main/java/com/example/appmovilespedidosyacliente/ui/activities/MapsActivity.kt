...
import com.example.appmovilespedidosyacliente.databinding.ActivityMapsBinding
            ...
            override fun onLocationResult(locationResult: LocationResult) {
                for (location in locationResult.locations) {
                    ...
                    binding.btnSaveLocation.setOnClickListener {
                        val intent = Intent()
                        // Asumiendo que 'currentMarker' contiene la última ubicación marcada
